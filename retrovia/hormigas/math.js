...
Matrix3.prototype.Rotation = function (angle) {
    var c = Math.cos(angle);
    var s = Math.sin(angle);

    this.a11 = c;    this.a12 = -s;   this.a13  = 0;
    this.a21 = s;    this.a22 = c;   this.a23  = 0;
    this.a31 = 0;    this.a32 = 0;   this.a33  = 1;
    return this;
};

Matrix3.prototype.Traslation = function (dx ,dy) {

    this.a11 = 1;    this.a12 = 0;   this.a13  = dx;
    this.a21 = 0;    this.a22 = 1;   this.a23  = dy;
    this.a31 = 0;    this.a32 = 0;   this.a33  = 1;
    return this;
};
...
Matrix3.prototype.multiply = function (M) {
	...
	var a11 = this.a11 * M.a11 + this.a12 * M.a21 + this.a13 * M.a31;
	var a12 = this.a11 * M.a12 + this.a12 * M.a22 + this.a13 * M.a32;
	var a13 = this.a11 * M.a13 + this.a12 * M.a23 + this.a13 * M.a33;

	var a21 = this.a21 * M.a11 + this.a22 * M.a21 + this.a23 * M.a31;
	var a22 = this.a21 * M.a12 + this.a22 * M.a22 + this.a23 * M.a32;
	var a23 = this.a21 * M.a13 + this.a22 * M.a23 + this.a23 * M.a33;

	var a31 = this.a31 * M.a11 + this.a32 * M.a21 + this.a33 * M.a31;
	var a32 = this.a31 * M.a12 + this.a32 * M.a22 + this.a33 * M.a32;
	var a33 = this.a31 * M.a13 + this.a32 * M.a23 + this.a33 * M.a33;
